            ...
            with st.expander("📖 Procedimiento del Diagnóstico", expanded=True):
                if par == "P y T":
                    ...
                    if t_in < t_sat - 0.05:
                        ...
                        estado = "Saturación"
                        st.success(f"**Resultado:** Estás en la línea de saturación.")
                    ...
                    st.write(f"1. A **{v1} bar**, los límites son $h_f = {hf:.2f}$ y $h_g = {hg:.2f}$ kJ/kg.")
                    ...
                    if h_in < hf:
                        ...
                        x = (h_in - hf) / (hg - hf)
                        st.success(f"**Resultado:** Mezcla Bifásica.")
                    ...
                    st.success("**Resultado:** Estado definido por título de vapor.")
                    if "P" in par:
                        ...
                        t_plot, v_plot = v1, 1 / PropsSI('D', 'T', t_k_base, 'Q', x_in, sustancia)
