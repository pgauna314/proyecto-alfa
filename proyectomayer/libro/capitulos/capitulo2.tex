...
\begin{tikzpicture}
    \begin{axis}[
        ...
        xmin=0, xmax=10,
        minor tick num=1,
        title={Diagrama $T-s$ Agua (Atucha II)}
    ]
        % La campana con los datos del .dat
        \addplot[blue, thick, smooth, tension=0.7] table {datos/campana_agua.dat};

        % Punto Crítico (Referencia)
        \filldraw[black] (axis cs:4.407, 373.95) circle (2pt) node[above] {PC};
    \end{axis}
\end{tikzpicture}
